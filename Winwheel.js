!function(t, e) {
    ...
    , function(t, e, r) {
        ...
        var n = r(1)
          ...
          , d = 2
          , s = function(t, e, r, a) {
            var n, l = (n = (n = o.append.call(t, "g"),
            o.attr).call(n, "id", "digit-" + a),
            o.style).call(n, "filter", "url(#motionFilter-" + a + ")");
            return u.forEach(function(t, a) {
                var n;
                (n = (n = o.append.call(l, "text"),
                o.attr).call(n, "y", -a * e * r),
                o.text).call(n, t)
            }),
            l
        }
          , p = function(t, e) {
            var r;
            return (r = (r = (r = (r = (r = (r = (r = o.append.call(t, "filter"),
          ...
          , y = function(t, e) {
            var r;
            return (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = (r = o.append.call(t, "linearGradient"),
          ...
          , h = function(t, e) {
            var r;
            return (r = (r = (r = (r = (r = (r = (r = o.append.call(t, "mask"),
          ...
          , m = function(t, e, r) {
            var a;
            return (a = (a = (a = o.attr.call(t, "width", e),
            o.attr).call(a, "height", r),
            o.attr).call(a, "viewBox", "0 0 " + e + " " + r),
            o.style).call(a, "overflow", "hidden")
        };
        e["default"] = function(t) {
            var e, r = t.el, a = t.from, n = t.to, i = t.lineHeight, g = void 0 === i ? 1.35 : i, b = t.letterSpacing, _ = void 0 === b ? 1 : b, x = t.animationDelay, j = void 0 === x ? 100 : x, M = t.letterAnimationDelay, w = void 0 === M ? 100 : M, O = (0,
            o.select)(r), P = window.getComputedStyle(O), S = parseInt(P.fontSize, 10), D = (S * g - S) / 2 + S / 10, E = S * g - D, F = Date.now(), B = 0, k = S * g + D;
            O.innerHTML = "";
            var A = o.append.call(O, "svg")
              , G = (e = o.append.call(A, "svg"),
            o.attr).call(e, "mask", "url(#mask-" + F + ")")
            ...
            z.forEach(function(t, e) {
                ...
                c["default"])({
                    ...
                    step: function(e) {
                        ...
                        (n = t.node,
                        o.attr).call(n, "transform", "translate(" + t.offset.x + ", " + t.offset.y + ")");
                        var l = (a - r) / 2
                          , i = Math.abs(Math.abs(e - r - l) - l) / 100;
                        (n = t.filter,
                        o.attr).call(n, "stdDeviation", "0 " + i)
                    },
                    end: 0 === e ? function() {
                        return N()
                    }
            ...
            var L = function(t) {
                ...
                z.forEach(function(t) {
                    var e;
                    (e = t.node,
                    o.attr).call(e, "transform", "translate(" + t.offset.x + ", " + t.offset.y + ")")
                }),
                m(A, B, k),
    ...
    , function(t, e) {
        ...
        e["default"] = function(t, e) {
            ...
            return this.style.setProperty(t, e, r),
            this
        }
    }
    , function(t, e) {
